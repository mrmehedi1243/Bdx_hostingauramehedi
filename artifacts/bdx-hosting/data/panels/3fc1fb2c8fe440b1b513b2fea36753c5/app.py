...
def ensure_jwt_token_sync(region):
    ...
    with jwt_lock:
        ...
        endpoints = {
            "IND": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "BR": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "US": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "SAC": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "BD": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "ID": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "PK": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "VN": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "ME": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "TH": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR",
            "default": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=5638858762&password=SulavXKawar_WNPR"
        }
        ...
        try:
            ...
            if token:
                ...
                print(f"[JWT] Token for {region} updated")
                return token

            print(f"[JWT] Failed to extract token for {region}. Response: {data}")
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="footer-links">
                <a href="https://t.me/t10xmehedi" target="_blank" class="btn btn-credit">
                    <i class="fab fa-telegram"></i><span>Credit: @MEHEDIXAURA</span>
                </a>
                <a href="https://t.me/MEHEDIXAURA" target="_blank" class="btn btn-power">
                    <i class="fas fa-bolt"></i><span>TELEGRAM CHHANAL: @MEHEDIXAURA</span>
                </a>
            </div>
        </div>
